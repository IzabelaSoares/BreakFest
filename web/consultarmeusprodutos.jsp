...
<html lang="pt-BR" dir="ltr">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input maxlength="30" style="height:40px; width:215px; box-shadow:none;  
                                                       ...
                                                       name = "tamanho" id="phone" placeholder="EX: Uma xícara de 60 ml" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea style="height:80px; width:310px; box-shadow:none; 
                                                          ...
                                                          aria-label="With textarea" placeholder="EX: Café Preto sem açúcar" required>
                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="container">
        ...
        <h1>Seus produtos cadastrados</h1><br>
        <div class="borda">
            <table class="table table-image">
                ...
                <tbody id="table">
                    <tr>
                        ...
                        <td name="excluirproduto"><a style="color: red" href="excluirproduto.jsp">Excluir</a></td>
                    </tr>
