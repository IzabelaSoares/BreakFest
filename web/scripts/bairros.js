...
const options = [ 'Vorstadt', 'Centro', 'Ribeirão Fresco', 'Garcia', 'Glória', 'Progresso', 
    'Valparaíso', 'Vila Formosa', 'Jardim Blumenau', 'Bom Retiro', 'Velha', 'Velha Central', 
    'Velha Grande', 'Passo Manso', 'Salto Weissbach', 'Escola Agrícola', 'Água Verde', 
    'Vila Nova', 'Itoupava Seca', 'Victor Konder', 'Boa Vista', 'Ponta Aguda', 'Nova Esperança', 
    'Itoupava Norte', 'Fortaleza', 'Tribess', 'Fortaleza Alta', 'Fidélis', 'Salto do Norte', 
    'Badenfurt', 'Testo Salto', 'Itoupavazinha', 'Itoupava Central', 'Vila Itoupava'
    ];
