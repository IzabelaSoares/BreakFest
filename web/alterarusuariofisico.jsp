...
<html>
    <head>        
        ...
        <script src="scripts/usuario-fisico.js"></script>
                ...
                <div class="modal-body">
                            ...
                            <div class="input-group-prepend">
                                <span class="input-group-append bg-white">
                                    <button class="btn" style=" height: 50px; background-color: #e9ecef !important; border-radius: 5px 0px 0px 5px;" type="button">
                                        <i class="fa fa-credit-card fa-2x" style="color: rgb(240, 62, 61);"></i>
                                    </button>
                                </span>       
                            </div>
                            <input type="text" class="form-control col-sm-8 border-0" id="dadoscard" readonly style=" margin: 0; height: 50px; border-left: none; border-radius: 0px 5px 5px 0px; color:#194a91;" 
                    ...
                    <div id="divcartao">
                        <div class="centrocartao">
                            <div class="container preload" style="margin-bottom: 0;">
